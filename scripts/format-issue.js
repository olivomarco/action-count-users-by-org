...
| Organization | Users | Unique Users | Description |
|-------------|-------|-------------|-------------|
`;

  // Add summary table rows
  for (const org of data.organizations) {
    const description = org.description.length > 70 
...
1. **Review user counts** in the summary table above (both total and unique)
